  ...
  return (
    <div className="w-screen h-screen bg-[url('/wyoming.jpg')] bg-cover overflow-hidden">
      <header className="absolute left-0 top-2/3 ml-6 sm:ml-12 md:ml-24 text-center sm:text-left">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl text-white">
          Hi, I&apos;m{" "}
          <span className={"text-blue-400"}>Alexander Prechtel</span>
          <br />
      ...
      <BottomNav
        items={[
          { href: "/", label: "Home" },
          {
            href: "https://instructions.webdev.aprechtel.xyz",
            label: "Instructions (ITIS-3135)",
            target: "_blank",
          },
        ]}
      />
